...
public class Grocery {
	...
	public static void main(String[] args){
		...
		System.out.println("Enter your Item OR type \"quit\" to exit.");
		userItem = in.next();
		
		while(!userItem.equalsIgnoreCase("quit")){
			...
			System.out.println("Please enter another item OR type \"quit\" to exit.");
			userItem = in.next();
		}
